...
class DiscountController extends Controller
{
    ...
    public function update(Update $request, Discount $discount)
    {
        ...
        $request->session()->flash('success', "Discount {$discount->name} has been updated successfully");
        return redirect(route('admin.discount.index'));
    }
    ...
    {
        $discount->delete();
        $request->session()->flash('success', "Discount {$discount->name} has been created");
        return redirect(route('admin.discount.index'));
    }
}
